...
exports.DefaultOwnerTransformer = void 0;
...
const getOwnerClaim = (ownerClaim) => {
    if (ownerClaim === 'username') {
        return getIdentityClaimExp((0, graphql_mapping_template_1.str)(ownerClaim), getIdentityClaimExp((0, graphql_mapping_template_1.str)(DEFAULT_COGNITO_IDENTITY_CLAIM), (0, graphql_mapping_template_1.str)(graphql_transformer_common_1.NONE_VALUE)));
    }
...
//# sourceMappingURL=amplify-graphql-default-owner-transformer.js.map